		...
		<div id="main">
			...
			<div class="wrapper">
				...
				<ul class="tags">
		    		...
		    		<li><a href="#" > vb.net + access </a></li> <!-- categoria 10 -->
		    		<li><a href="#" > redes </a></li> <!-- categoria 15 -->
		    		<li><a href="#" > reparacion + mantenimiento  </a></li> <!-- categoria 17 -->
		    		<li><a href="#" > vb.net + SQL server </a></li> <!-- categoria 18 -->
...
$query_tb = "SELECT nombre,extracto,fecha FROM $tabla_proyecto";
				...
				<div class="footer-right">
					...
					<form id="contactForm" action="#" method="post">
						<fieldset>
							...
							<div>
								<textarea  name="comments"  id="comments" rows="5" cols="20" class="form-poshytip" title="Te puedo ayudar en algo?" onFocus="defaultInput(this,'Te puedo ayudar en algo?')" onBlur="clearInput(this,'Te puedo ayudar en algo?')" >Te puedo ayudar en algo?</textarea>
							</div>
