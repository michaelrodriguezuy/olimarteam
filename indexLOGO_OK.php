...
<!--
				...
				<!-- ENDS Social -->
 				...
 				<a href="index.php"><img src="img/logo23.png" alt="olimarteam" name="logo" height="126" id="logo" /></a>
			...
			<div class="wrapper">
				...
				<div class="footer-left">
					...
					<ul class="skills">
						...
						<li class="stars-4"><span>HTML</span></li>
					...
					<form id="contactForm" name="form1" action="<?php echo $editFormAction; ?>" method="post">
						<fieldset>
							<div>
							  ...
							  <input name="nombre"  id="name" type="text" class="form-poshytip" title="Cual es tu nombre?" value="Nombre" onFocus="defaultInput(this,'Nombre')" onBlur="clearInput(this,'Nombre')" />
							</div>
							<div>
								<input name="email"  id="email" type="text" class="form-poshytip" title="Ingrese un email válido" value="Email" onFocus="defaultInput(this,'Email')" onBlur="clearInput(this,'Email')"  />
							</div>
							<div>
								<textarea  name="comentario"  id="comments" rows="5" cols="20" class="form-poshytip" title="Te puedo ayudar en algo?" onFocus="defaultInput(this,'Te puedo ayudar en algo?')" onBlur="clearInput(this,'Te puedo ayudar en algo?')" >Te puedo ayudar en algo?</textarea>
							</div>			
                                                 
           <p><input type="submit" value="Enviar" name="submit" id="submit" /></p>

           <strong><input type="hidden" name="MM_insert" value="form1"></strong>
                        
							<!-- send mail configuration -->
							<input type="hidden" value="olimarteam@gmail.com" name="to" id="to" />
							<input type="hidden" value="Email" name="from" id="from" />
...
<p id="success" class="success">Gracias por sus comentarios.</p>
		...
		<div id="bottom">
			<!-- wrapper-bottom -->
			<div class="wrapper">
				<div id="bottom-text"><a href="index.php" >olimarteam</a> 2015 by Michael Rodríguez </div>
				<div  class="to-top poshytip" title="ir arriba">arriba</div>
			</div>
			<!-- ENDS wrapper-bottom -->
		</div>
