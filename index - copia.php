...
//LuEGO DE INSTERTAR EL CORREO EN LA BASE Y ENVIARLO A MI CORREO, VOY A LA PAGINA DE ENVIO OK
...
?>
		...
		<form id="contactForm" name="form1" action="sendmail.php" method="POST">
                    <!--
            ...
            <span id="sprytextfield1">
			 <input name="name" type="text" class="form-poshytip"  id="name" title="Cual es tu nombre?" onFocus="defaultInput(this,'Nombre')" value="Nombre" />						 			 <span class="textfieldRequiredMsg">*</span>
             </span>
            </div>
			<div>
            <span id="sprytextfield2">
			 <input name="email" type="text" class="form-poshytip"  id="email" title="Ingrese un email válido" onFocus="defaultInput(this,'Email')" value="Email"  />
			 <span class="textfieldRequiredMsg">*</span>
             </span>
            </div>
            <div>
			 <input name="city"  id="city" type="text" class="form-poshytip" title="Cual es tu ciudad?" value="Ciudad" onFocus="defaultInput(this,'Ciudad')" />
			</div>
            <div>
             <input name="country"  id="country" type="text" class="form-poshytip" title="Cual es tu pais?" value="Pais" onFocus="defaultInput(this,'Pais')" />
              </div>
			<div>
