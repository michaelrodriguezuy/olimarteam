<!DOCTYPE html>
<html><head><?php require_once('Connections/olimarteam.php'); ?><?php if (!function_exists("GetSQLValueString")) {
...
mysql_select_db($database_olimarteam, $olimarteam);
$query_Recordset1 = "SELECT * FROM cliente WHERE cliente.id_cliente<>1 ORDER BY cliente.nombre";
$Recordset1 = mysql_query($query_Recordset1, $olimarteam) or die(mysql_error());
...
<script>
  ...
  ga('send', 'pageview');
		...
		<meta charset="utf-8"><title>olimarteam</title>
		
		
		<link rel="icon" href="favicon.ico" type="image/x-icon"><!-- CSS -->
		
		
		<link rel="stylesheet" href="css/style.css" type="text/css" media="screen">
		<link rel="stylesheet" href="css/social-icons.css" type="text/css" media="screen">
		<link rel="stylesheet" href="" type="text/css" media="screen" id="css-skins"><!--[if IE 8]>
			<link rel="stylesheet" type="text/css" media="screen" href="css/ie8-hacks.css" />
		<![endif]--><!-- ENDS CSS --><!-- GOOGLE FONTS -->
		
			
		
		
		<link href="http://fonts.googleapis.com/css?family=Yanone+Kaffeesatz:light" rel="stylesheet" type="text/css"><!-- JS -->
		...
		<script src="js/custom.js"></script><!--[if IE]>
		...
		<link rel="stylesheet" media="screen" href="css/superfish.css"><!-- <link rel="stylesheet" media="screen" href="css/superfish-left.css" /> --> 
		...
		<script type="text/javascript" src="js/poshytip-1.0/src/jquery.poshytip.min.js"></script><!-- ENDS poshytip --></head><body>
...
<!-- HEADER -->
			...
			<div class="wrapper">
			  ...
			  <ul class="social">
					...
					<li><a target="_blank" href="https://uy.linkedin.com/in/michaelR33" class="poshytip linkedin" title="Siguenos"></a><br>
</li>					
									
				  <li><a href="mailto:info@olimarteam.com" class="poshytip email" title="Escribenos"></a><br>
</li>
					<li><a href="skype:olimarteam?chat" class="poshytip skype" title="Chat"></a><br>
</li>
...
<!-- SI LINKEA AL SITIO WEB DEL CLIENTE -->
                   ...
                   <?php if($row_Recordset1!=NULL){ do { $letra = substr($row_Recordset1['nombre'], 0, 1);   ?>
  
  					<?php if ((substr($row_Recordset1['nombre'], 0, 1))!=$letra2) { ?> <!-- aca entro si el siguiente cliente empieza con distinta letra -->
                  
<ul>

                        <li><span><?php echo $letra ?> </span> <br>
</li>
                      
                        
	                        <li><a target="_blank" href="%3C?php%20echo%20$row_Recordset1%5B%27web%27%5D;%20?%3E"> <?php echo $row_Recordset1['nombre']; ?></a><br>
</li>
	                        <?php }else { ?><li><a target="_blank" href="%3C?php%20echo%20$row_Recordset1%5B%27web%27%5D;%20?%3E"> <?php echo $row_Recordset1['nombre']; ?></a><br>
</li>
                           
                    
                  <!-- aca entro si el siguiente cliente empieza con la misma letra -->
	     		     <?php $letra2=$letra; } ?> 
                   <li><a href="#" class="to-list"> Volver a la lista</a></li>
		...
		<div id="footer">
			...
			<div class="wrapper">
				...
				<div class="footer-left">
					...
					<p>
Estamos ubicados en la ciudad de Treinta y Tres, Uruguay. Hemos estado
desarrollando software desde hace varios años. Si bien no tenemos mucho
tiempo en el mercado local, hemos adquirido experiencia, de las
distintas empresas por las cuales hemos pasado y/o con quienes hemos
trabajado en distintos proyectos.</p>

					<p>Nos especializamos en
el análisis y desarrollo de aplicaciones de escritorio y sitios web.
Cada producto que realizamos, se basa en los últimos principios y
técnicas de desarrollo. Para saber más acerca de lo que podemos hacer
por ti, revisa algunos de los trabajos que hemos realizado, o ponete en
contacto con nosotros por <a href="mailto:info@olimarteam.com">email</a> o telefónicamente al (+598) 99 163 200.</p>
			...
			<div>                        
			 <input class="form-poshytip" id="name" title="Cual es tu nombre?" onfocus="defaultInput(this,'Nombre')" placeholder="Nombre" value="&lt;?php echo $_POST[" name="name" ];="" ?="" type="text">' &gt;
			 <?php echo $error1 ?>
            </div>
      
            
			<div>                        
			 <input name="email" class="form-poshytip" id="email" title="Cual es tu email?" onfocus="defaultInput(this,'Email')" placeholder="Email" value="&lt;?php echo $_POST[" email="" ];="" ?="" type="text">'&gt;
			 <?php echo $error2 ?>
            </div>
            
            <div>
			 <input name="city" id="city" class="form-poshytip" title="Cual es tu ciudad?" placeholder="Ciudad" value="&lt;?php echo $_POST[" city="" ];="" ?="" type="text">'&gt;
			 <?php echo $error3 ?>
			</div>
            
            <div>
             <input name="country" id="country" class="form-poshytip" title="Cual es tu pais?" placeholder="País" value="&lt;?php echo $_POST[" country="" ];="" ?="" type="text">'&gt;
			 <?php echo $error4 ?>
              </div>
			...
			<p><input value="Enviar" name="submit" id="submit" type="submit"></p> 
                                        
			</fieldset>
                      
            <input name="MM_insert" value="contactForm" type="hidden">
	       <?php echo $result; ?>
		</form>
	...
	<?php mysql_free_result($DatosClientes);
