...
<!-- SI LINKEA AL SITIO WEB DEL CLIENTE -->
                  ...
                  <ul id="letter-<?PHP echo $letra ?>" class="tags listing">
                        <li><span><?PHP echo $letra ?> </span> </li>
	                        ...
	                        <li><a target="_blank" href="<?php echo $row_Recordset1['web']; ?>"> <?php echo $row_Recordset1['nombre']; ?></a></li>
	                        <?php }else { ?><li><a target="_blank" href="<?php echo $row_Recordset1['web']; ?>"> <?php echo $row_Recordset1['nombre']; ?></a></li>
