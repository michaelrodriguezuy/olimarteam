...
Usuario: <?php echo $_SESSION['usuarioactual']; ?> 
	  ...
	  <div id="main">   
	    ...
	    <div align="center">
	      <h1><a href="listado_usuarios.php"><img src="img/knobs-icons/Knob Search.png" width="32" height="32" alt="Ver usuarios"></a><a href="insertar_mascota.php" target="_blanc"><img src="img/knobs-icons/Knob Add.png" width="32" height="32" longdesc="img/knobs-icons/Knob Add.png" alt="Insertar mascota"></a> Listado de mascotas: </h1>
