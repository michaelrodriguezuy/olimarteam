...
<html>
 ...
 <!-- favicon-->
	...
	function asegurar()
	{
	  ...
	  <div id="main"> 
	    <div align="center">
	      <h1><a href="insertar_usuario.php" target="_blanc"><img src="img/knobs-icons/Knob Add.png" width="32" height="32" longdesc="img/knobs-icons/Knob Add.png" alt="Insertar"></a> Listado de usuarios: </h1>
