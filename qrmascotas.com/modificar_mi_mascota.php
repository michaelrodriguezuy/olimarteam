...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE mascota SET tipo=%s, apodo=%s, raza=%s, color=%s, foto=%s, observacion=%s, fecha_nacimiento=%s WHERE id_mascota=%s",
...
//ME QUEDE ACA, PASAR EL ID DEL USUARIO LUEGO DE MODIFICAR LAS MASCOTA
$updateGoTo = 'mi_mascota.php?recordID='.$row_DatosUsuarios['id_usuario'];  
 ...
 // header(sprintf("Location:", "mi_mascota.php?recordID=".$row_DatosUsuarios['id_usuario']));
}
...
function subirimagen(nombrecampo)
{
    ...
    <p>&nbsp;</p>
        ...
        <a href="salir.php"><img src="img/knobs-icons/Knob Cancel.png" width="32" height="32" border="0" title="Cerrar sesion"></a> <a href="mi_mascota.php?recordID=<?php echo $row_Datosmascotas['id_usuario']; ?>"><img src="img/knobs-icons/Knob Left.png" width="32" height="32" border="0" title="Volver Mi Mascota"></a>
      </div>
		<!-- ENDS MAIN -->
