...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO usuario (nombre, usuario, password, celular, email, direccion, localidad, `admin`) VALUES (%s, %s, MD5(%s), %s, %s, %s, %s, %s)",
